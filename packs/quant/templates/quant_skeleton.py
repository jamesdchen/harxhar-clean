...
# results. The concrete realized-volatility PROGRAM template lives one layer down
# at packs/rv/templates/rv_audit.py (that seat, not this one, is what audits
# reference). See packs/README.md for the layer table and portability test.
#
...
# comments of the SIGNED template specs/audit_template_run10.py (harxhar-clean
# commit e9ff215) — the working, signed precedent. Only the DISCIPLINE is lifted;
...
#
# SIGNATURE GATE / GROWTH (see packs/README.md): when the user signs
# specs/audit_template_rv.py (commit-as-signature), TWO things move together —
# the rv pack's rv_audit.py seat swaps to the 12-slug inventory, AND this domain
# skeleton grows the 12-slug section inventory (the reusable superset of the
# 5-slug kernel below). Do NOT grow it before the user signs.
# ============================================================================
...
(packs/rv/ does not — its target's raw scale is variance); the contract is the
...
program-layer affordance (a concrete pinned cell in packs/rv/), never a domain
