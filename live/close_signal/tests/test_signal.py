...
def test_small_budget_switches_the_card_and_title_to_xsp() -> None:
    ...
    assert "XSP 757.5 put + 758 call, expiring today." in card
    assert "Robinhood: Long Strangle, width 0.5, date (0d), row 757.5 / 758." in card
    assert f"(no 757.5 put? buy {fri.n_xsp_at_pstar} XSP 757 put + 758 call" in card
