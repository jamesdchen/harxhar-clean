...
sub () {  # ens_w gate label
  local J C
  J=$(qsub -terse -v CID=$CID,RMODEL=ebm_mtfm,RDEPTH=2,EXPERT=fm,ENS_W=$1,MT_GATE=$2,MT_AUXHI=0.6,MT_AUXW=0.3,MT_NBAGS=8,MT_RANK=4,MT_EPOCHS=250,EBM_CFG={},RDIAG=false,LBL=$3 moe_dig.sge | cut -d. -f1)
