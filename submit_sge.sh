...
J0=$(qsub -terse -v CID=$CID,RDEPTH=0,RDIAG=false,WD=0.1,LBL=reg_d0 moe_dig.sge | cut -d. -f1)
C0=$(qsub -terse -hold_jid "$J0" -v CID=$CID,ARM=resid_regime,LBL=reg_d0 sig_collect.sge)
