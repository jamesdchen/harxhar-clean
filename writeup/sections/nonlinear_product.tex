...
The three-block ridge scores QLIKE \unifBlkThreeUserQLIKE{}, with
Diebold--Mariano \unifBlkThreeUserDM{} against the OLS--HAR incumbent;
under the documented convention it scores \unifBlkThreeDocQLIKE{} at
\unifBlkThreeDocDM{}. \pending{per-bar DM statistic for the product-block
increment (three-block vs.\ two-block on the same rows) --- computed from
the persisted per-bar losses at harvest}
