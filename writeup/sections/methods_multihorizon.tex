...
variance of each of the next eleven bars, $t+1, \dots, t+11$, one
left-hand side per horizon, so that the eleven forecasts at $t$ form
the sequence of the next five and a half hours and their running sum
the variance to any point within it. The rolling Gram matrix does not
