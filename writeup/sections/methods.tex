...
and $\gamma_b = \sqrt{\alpha_b}\,\beta_b$,
\[
...
\iffalse
\input{sections/methods_options}
\fi
\input{sections/methods_close_option}
% PARKED 2026-08-28: rest-of-session / multi-horizon held out of the rendered paper.
\iffalse
\input{sections/methods_multihorizon}
\fi
\input{sections/methods_bsm}
