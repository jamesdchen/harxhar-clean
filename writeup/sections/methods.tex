...
(Section~\ref{sec:dp_benchmark}); the back-transformation from the
fitting scale to the variance scale and the calibrated, strictly causal
second-moment correction it carries (Section~\ref{sec:smearing}); and
the inheritance rule that makes the whole stack binding on every
