...
control; every constant it names was set before the portfolio was scored.
...
\begin{equation}
    ...
    \label{eq:opt_signal}
\end{equation}
so the portfolio sells the contract and hedges it when the option is expensive
...
is the fixed constant $\theta = 0.10$, set before the portfolio was scored;
...
rate is the fraction of positive days. The portfolio is reported for the whole
...
is what any conditional portfolio must be measured against. The rule is then
