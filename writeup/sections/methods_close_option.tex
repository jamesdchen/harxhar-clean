...
(QLIKE improves for all seven models), not on any portfolio outcome. A median-targeting map (the same line fitted by weighted least
...
Sharpe ratio for six of the seven forecasts (block-diagonal ridge 1.63
to 0.70).
