...
(QLIKE improves for all seven models), not on any portfolio outcome.
...
% removed from the portfolio. Sizing linear in the premium's magnitude failed
...
portfolio fall on days sized at or near it --- days on which the forecast
...
fraction is estimated causally from the portfolio's own past returns,
\begin{equation}
    \hat f_t \;=\;
    \min\!\left(
...
the frame for the plain portfolio --- $f_t$ is the share of wealth
...
the unfiltered portfolio, not before it;
...
forecast on about 61\% of days, so the portfolio leans short more often
...
Equation~\eqref{eq:close_opt_kelly}, which reads the portfolio's own past
