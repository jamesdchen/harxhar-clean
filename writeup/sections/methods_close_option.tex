...
the two measurements, the position rules, a defined-risk variant, and the
...
good its mean --- the defined-risk variant above bounds the worst day
by construction, which is exactly what would loosen this constraint. The
...
day is bounded; it applies to the defined-risk variant. One unit
