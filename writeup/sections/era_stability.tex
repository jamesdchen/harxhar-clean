...
design of Section~\ref{sec:stripped} is included because its behaviour in the
failing era is the point.}
\label{tab:eras}
\begin{tabular}{llrrr}
\toprule
...
Section~\ref{sec:fill_defect}: a series absent from the raw data, forward-
