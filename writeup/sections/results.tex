...
solver, two penalties, refit every bar; the next subsection extends its
forecast from one bar to the rest of the session.

% OPTIONS PARKED 2026-08-18: option-market results held out of the rendered paper.
\iffalse
