...
% OPTIONS PARKED 2026-08-18: all-session delta-hedged leg book held out.
\iffalse
...
\optBareBlkLong{} long. Neither forecast-conditioned book clears the
quoted spread at this sample under this rule; the ordering of the two
forecasts on the book matches their ordering in
Table~\ref{tab:block_ladder}. The book is a demonstration under stated
