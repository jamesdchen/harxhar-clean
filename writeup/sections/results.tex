...
% under the contract of Section 3 and the methods of Section 4.

The results run from information to estimator to structure.
...
\subsection{The Same Buckets under Shrinkage}
...
\subsection{Dense but Weak: Lasso versus Ridge}
