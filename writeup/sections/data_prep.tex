...
OLS on the HAR ladder plus this FOMC calendar bucket beats HAR +
calendar OLS on the shared evaluation panel
...
the FOMC channels included among the rest, still loses to HAR +
calendar OLS.
...
$t$ versus HAR + calendar OLS; negative $t$ favors the arm.}
