...
would be a further change of protocol. Table~\ref{tab:buckets}
was regenerated under the current protocol on 2026-08-13 (and its
attribution flipped accordingly, as Section~\ref{sec:buckets} records);
Tables~\ref{tab:buckets_tuned} and \ref{tab:lasso_vs_ridge} still
carry first-iteration scalar-protocol rows (incumbent
\unifAzeroQLIKEScalar{}), internally consistent within each table,
pending the tuned-grid harvest launched 2026-08-13.
...
agreement statistics quoted there ($\tau$ against the calibrated-protocol ranking:
