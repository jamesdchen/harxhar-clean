...
would be a further change of protocol. Tables~\ref{tab:buckets},
\ref{tab:buckets_tuned}, and \ref{tab:lasso_vs_ridge} currently carry
rows scored under the campaign's \emph{first-iteration} scalar
protocol (incumbent \unifAzeroQLIKEScalar{}), internally consistent
within each table; their re-harvest under the current protocol was
submitted on 2026-08-11 and the tables will be regenerated from the
scorer when it completes.
