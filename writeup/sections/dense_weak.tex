...
\unifBTwoLassoTunedDM{}). Keeping every column and shrinking produces a
lower loss than selecting a subset, when both strategies choose their
penalty by the same causal rule.
