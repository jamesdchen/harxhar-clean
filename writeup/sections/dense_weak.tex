...
\unifBTwoLassoTunedDM{}); the elastic net, the interpolating family at the
battery's mixed-penalty grid, scores \unifBThreeEnetTunedQLIKE{}
(\unifBThreeEnetTunedDM{}). Keeping every column and shrinking produces a
lower loss than selecting a subset, when every family chooses its penalty
by the same causal rule.
