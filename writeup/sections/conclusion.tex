...
(Section~\ref{sec:close_option_results}): quoted implied already sits
above the forecast on the bulk of days, so the last-bar book is
mostly a short, and what the forecast adds is size on that short
