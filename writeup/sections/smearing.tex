...
\emph{exactly} the scalar $\hat{\sigma}^2_k$ of
Equation~\eqref{eq:var_reg}. The scalar contract is therefore nested as
...
any increment produced by changing the conditional mean.
