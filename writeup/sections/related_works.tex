...
15:30 is when that bird has already flown: quoted implied variance
already exceeds the remaining-variance forecast on the bulk of
expiration days, so a two-sided reading of the forecast is mostly a
short, and what the forecast adds is size on that short rather than a
directional flip. We do not restage their next-day VVIX regression;
the object here is same-day remaining variance against the
expiration-day chain.