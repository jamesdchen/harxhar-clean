...
benchmark's \unifAzeroQLIKE{}. The paper closes beyond one bar
(Section~\ref{sec:multihorizon}): refitting the estimator directly at
horizons from thirty minutes to a week, it asks whether the exogenous
advantage decays with horizon --- it grows --- and, within the session,
extends the one-step forecast to the variance remaining before the
close at every bar.
