...
(32 to 43 percent, depending on the forecast), a $\pm 1$
portfolio on $\mathrm{sign}(s)$ improves on the unconditional short for every
one of the seven forecasts, and the signal's magnitude adds nothing to its
sign
