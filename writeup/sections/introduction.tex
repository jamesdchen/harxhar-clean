...
benchmark's \unifAzeroQLIKE{}. The paper closes by extending the
one-bar forecast to the variance remaining in the session --- the
multi-horizon object an intraday user needs at every bar --- and asks
whether the two-block ridge's advantage carries to it
(Section~\ref{sec:multihorizon}).
