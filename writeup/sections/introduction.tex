...
backbone, no bucket improves on the benchmark under plain least squares
--- five of seven are significantly worse --- and stacked into one wide
design, the unpenalized joint fit is worse than every bucket it
contains. Under causal shrinkage the ordering reverses: the joint
