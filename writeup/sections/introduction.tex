...
against quoted implied --- and shows that quoted implied already sits
above the forecast on the bulk of days, so the reading is mostly a
short: the forecast has no usable directional edge, and what it adds
is size on that short
