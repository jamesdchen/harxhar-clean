% Standalone render of generated_intraday/table_rule_by_strategy_intraday_1530.tex
% Build: pdflatex -interaction=nonstopmode rule_by_strategy_intraday_1530.tex
...
\begin{document}
\begin{center}
\textbf{0DTE nearest-OTM package: per-rule return summary, entry 15:30 ET, cash-settled at the close, models compared on the same 866 days}\\[1.5ex]
