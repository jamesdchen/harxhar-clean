% Standalone render of generated_intraday/table_rule_by_strategy_intraday_pooled.tex
% Build: pdflatex -interaction=nonstopmode rule_by_strategy_intraday_pooled.tex
...
\begin{document}
\begin{center}
\textbf{0DTE nearest-OTM package: per-rule return summary, pooled over the twelve entry windows 10:00--15:30 ET (daily sums), models compared on the same 866 days}\\[1.5ex]
