...
\vspace{1ex}
\begin{center}
\includegraphics[width=0.45\textwidth]{../results/atm_straddle_intraday/rule_by_strategy/pooled/rule_hists_blk2_pooled.png}\par\smallskip
...
\end{center}
\begin{center}
\includegraphics[width=0.45\textwidth]{../results/atm_straddle_intraday/mean_by_entry_hhmm_as.png}\par\smallskip
\small Mean $R'$ and Sharpe$_{\mathrm{clk}}$ by entry clock (grouped bars). Sharpe$_{\mathrm{clk}}$ is that clock's daily series $\times\sqrt{252}$, not the pooled Sharpe$_{\mathrm{ann}}$. Next-mid 30-minute holds 10:00--15:00; 15:30 cash-settles at the official close.
\end{center}
\begin{center}
\includegraphics[width=0.45\textwidth]{../results/atm_straddle_intraday/confusion_by_clock.png}\par\smallskip
