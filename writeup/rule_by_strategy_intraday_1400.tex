% Standalone render of generated_intraday/table_rule_by_strategy_intraday_1400.tex
% Build: pdflatex -interaction=nonstopmode rule_by_strategy_intraday_1400.tex
...
\begin{document}
\begin{center}
\textbf{0DTE nearest-OTM package: per-rule return summary, entry 14:00 ET, one-bar hold, models compared on the same 866 days}\\[1.5ex]
