...
( PB_START=24000 PB_END=26189 TAG=rff_t1 "$PY" "$SP/rff_corr.py" > logs/rff_t1.log 2>&1 && echo DONE > logs/rff1_done.marker ) &
( PB_START=26189 PB_END=28378 TAG=rff_t2 "$PY" "$SP/rff_corr.py" > logs/rff_t2.log 2>&1 && echo DONE > logs/rff2_done.marker ) &
wait
