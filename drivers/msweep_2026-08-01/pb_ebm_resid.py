...
"""EBM in the residual seat: per-bar ridge base + EBM correction + stack.
...
for seg in range(0, n1 - n0, 240):
    ...
    mdl = ExplainableBoostingRegressor(n_jobs=2)
