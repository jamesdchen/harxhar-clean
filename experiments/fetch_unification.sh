#!/bin/bash
# Pull the unification campaign's npz trees from both clusters into
# results/unification_carc/ and results/unification_h2/ (run locally, Git
# Bash). Incremental: tar streams everything; rerunning overwrites in place.
set -e
